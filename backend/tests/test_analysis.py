...
class TestRecommendations:
    ...
    def test_high_risk_recommendations(self, analyzer):
        ...
        assert any(
            "gynecologist" in r.lower() or "endocrinologist" in r.lower()
    ...
    def test_weight_gain_symptom_recommendations(self, analyzer):
        ...
        assert any(
            "nutritionist" in r.lower() or "diet" in r.lower() for r in recommendations
        )
    ...
    def test_sedentary_recommendations(self, analyzer):
        ...
        assert any(
            "exercise" in r.lower() or "physical" in r.lower() for r in recommendations
        )
...
class TestSummaryGeneration:
    ...
    def test_moderate_risk_summary(self, analyzer):
        ...
        data = {"age": 25, "cycle_length": 32, "period_length": 6, "symptoms": []}
    ...
    def test_low_risk_summary(self, analyzer):
        ...
        data = {"age": 30, "cycle_length": 28, "period_length": 5, "symptoms": []}
...
class TestFullAnalysis:
    ...
    def test_full_analysis_returns_all_fields(self, analyzer):
        ...
        with patch.object(
            ...
            return_value={"avg_cycle_length": 28, "avg_period_length": 5},
        ):
